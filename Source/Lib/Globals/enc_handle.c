...
static void copy_api_from_app(
    ...
    //*******************vmaf_model_path*****************//
    scs->static_config.vmaf_model_path=config_struct->vmaf_model_path;
    //fprintf(stderr, "config_struct vmaf path:%s  scs: %s\n", config_struct->vmaf_model_path,scs->static_config.vmaf_model_path);
    return;
}
